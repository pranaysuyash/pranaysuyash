...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:6EE7F7,100:A78BFA&height=200&section=header&text=Pranay%20Suyash&fontSize=60&fontColor=fff&fontAlignY=38&desc=Builder.%20Tinkerer.%20Shipping%20AI-powered%20products.&descAlignY=58&descAlign=50" width="100%" />

[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&size=20&pause=1000&color=A78BFA&center=true&vCenter=true&width=600&lines=Full-Stack+AI+Product+Builder;macOS+%26+Mobile+Native+Developer;Multi-Agent+Systems+Enthusiast;Computer+Vision+%26+Speech+AI;Rapid+Prototyper+%E2%80%94+Ships+Real+Products)](https://git.io/typing-svg)
...
I'm a **full-stack builder** who ships products end-to-end — from Swift menu-bar apps to Python AI pipelines. I love integrating AI into real tools that actually work.

- 🧠 **AI & Multi-Agent** systems, computer vision, speech, and semantic search  
- 🍎 **Native macOS & Flutter** apps that feel like they belong  
- ⚡ **Full-Stack** — React + TypeScript frontends, FastAPI/Node.js backends, PostgreSQL  
- 🔬 Currently exploring: real-time audio intelligence, LLM agents, on-device ML with MLX  
...
Extracts **45,000+ metadata fields** from any file type — images, video, documents — with forensic-grade precision, access control, and a credit/payment system.  
...
Computer-vision app that **guides the visually impaired and elderly** through real-world environments using AI scene understanding and audio descriptions.  
...
Cross-platform Flutter app for **AI-powered waste identification** and recycling guidance, with detailed material recognition and environmental education features.  
...
Local-first **multi-agent orchestration platform** — protocol-first, human-gated risk tiers, supports OpenAI / Anthropic / Ollama / LangGraph with durable snapshot recovery.  
...
Isochrone travel-time maps for any location in India with **AI-generated Hinglish captions** (Claude / GPT). A love letter to India's most optimistic unit of time.  
...
Native **macOS Swift app** for managing and organizing browser tabs — built with SwiftUI and a structured staging-first delivery model.  
`Swift` `SwiftUI` `macOS`
...
### 📸 [PhotoSearch Experiment](https://github.com/pranaysuyash/photosearch-experiment)
Modular Python AI **photo workstation** — face recognition, semantic search, clustering — designed as a commercial Studio prototype.  
`Python` `React` `CLIP` `AI/ML` `Computer Vision`
...
![Whisper](https://img.shields.io/badge/Whisper-FF6F00?style=flat-square&logo=openai&logoColor=white)
...
- **EchoPanel** — Adding diarization, speaker separation, and real-time semantic search over transcripts  
- **Multi-Agent Platform** — Extending the agents repo with visual workflow builder and eval harness  
- **On-Device ML** — Running MLX models locally for speech, vision, and text without cloud API calls  
- **Robonomics** — Building out cost benchmarks for humanoid robots as they hit the market  
